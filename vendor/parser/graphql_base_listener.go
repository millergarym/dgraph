...
// EnterTypeA is called when production typeA is entered.
func (s *BaseGraphQLListener) EnterTypeA(ctx *TypeAContext) {}

// ExitTypeA is called when production typeA is exited.
func (s *BaseGraphQLListener) ExitTypeA(ctx *TypeAContext) {}
