...
type GraphQLListener interface {
	...
	// EnterTypeA is called when entering the typeA production.
	EnterTypeA(c *TypeAContext)
	...
	// ExitTypeA is called when exiting the typeA production.
	ExitTypeA(c *TypeAContext)
