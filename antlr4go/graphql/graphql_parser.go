...
var ruleNames = []string{
	...
	"defaultValue", "valueOrVariable", "value", "typeA", "typeName", "listType",
	"nonNullType", "array",
}
...
func (s *VariableDefinitionContext) TypeA() ITypeAContext {
	var t = s.GetTypedRuleContext(reflect.TypeOf((*ITypeAContext)(nil)).Elem(), 0)

	if t == nil {
		return nil
	}

	return t.(ITypeAContext)
}
...
// ITypeAContext is an interface to support dynamic dispatch.
type ITypeAContext interface {
	antlr.ParserRuleContext

	// GetParser returns the parser.
	GetParser() antlr.Parser

	// IsTypeAContext differentiates from other interfaces.
	IsTypeAContext()
}

type TypeAContext struct {
	*antlr.BaseParserRuleContext
	parser antlr.Parser
}

func NewEmptyTypeAContext() *TypeAContext {
	var p = new(TypeAContext)
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = GraphQLParserRULE_typeA
	return p
}

func (*TypeAContext) IsTypeAContext() {}

func NewTypeAContext(parser antlr.Parser, parent antlr.ParserRuleContext, invokingState int) *TypeAContext {
	var p = new(TypeAContext)
...
func (s *TypeAContext) GetParser() antlr.Parser { return s.parser }

func (s *TypeAContext) TypeName() ITypeNameContext {
	var t = s.GetTypedRuleContext(reflect.TypeOf((*ITypeNameContext)(nil)).Elem(), 0)
...
func (s *TypeAContext) NonNullType() INonNullTypeContext {
...
func (s *TypeAContext) ListType() IListTypeContext {
...
func (s *TypeAContext) GetRuleContext() antlr.RuleContext {
	return s
}

func (s *TypeAContext) ToStringTree(ruleNames []string, recog antlr.Recognizer) string {
	return antlr.TreesStringTree(s, ruleNames, recog)
}

func (s *TypeAContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(GraphQLListener); ok {
		listenerT.EnterTypeA(s)
	}
}

func (s *TypeAContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(GraphQLListener); ok {
		listenerT.ExitTypeA(s)
	}
}

func (p *GraphQLParser) TypeA() (localctx ITypeAContext) {
	localctx = NewTypeAContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 48, GraphQLParserRULE_typeA)
	var _la int
...
func (s *ListTypeContext) TypeA() ITypeAContext {
	var t = s.GetTypedRuleContext(reflect.TypeOf((*ITypeAContext)(nil)).Elem(), 0)
